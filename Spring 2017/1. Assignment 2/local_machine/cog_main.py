...
class GradeSubmission():
    ...
    def initialize_assignment_specifics(self):
        ...
        self.required_functions = ["void calculatePopulation(void)",
                              "void secondsToTime(void)",
                              "void celsiusToFahrenheit(void)"]


        self.catch_phrases = ["The population is",
                         "The time is",
                         "degrees celsius is"]
    ...
    def parse_student_answers(self, student_answers):
        ...
        studentFeedback("answers_list: {}".format(answers_list))
    ...
    def test_cases(self, helper_path):
        ...
        for index, (expected_answer, student_answer) in enumerate(zip(expected_outputs, student_answers)):
            ...
            function_name_index = math.floor(index/3)
