...
void printEnergy(double panel_area, double panel_efficiency, double solar_radiation_ave, double performance_ratio)
{
	...
	// Print output
	cout << "The annual average solar energy for an efficiency of " << panel_efficiency
...
int main(void)
{
	...
	// Obtain the user input
	cout << "Solar panel area (m^2): ";
	cin >> panel_area;

	cout << "Solar panel efficiency (%): ";
	cin >> panel_efficiency;

	cout << "Average Solar Radiation (kWh / m^2): ";
	cin >> solar_radiation_ave;
