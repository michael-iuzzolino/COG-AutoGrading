...
class SubmissionFinder:
    ...
    def validateFileName(self, expectedFileName, actualFileName, exact=False):
        """
        ...
        # Condition 2
        if exact:
            containsText = expectedFileName.lower() == actualFileName.lower().replace(".cpp", "")   # "a in b" returns True or False
        else:
            containsText = expectedFileName.lower() in actualFileName.lower().replace(".cpp", "")   # "a in b" returns True or False
    ...
    def findSubmission(self, submissionDirectory, expectedFileName, exact=False):
        """
        ...
        try:
            ...
            for submissionFile in submissionFiles:
                ...
                if (self.validateFileName(expectedFileName, submissionFile, exact=exact)):
